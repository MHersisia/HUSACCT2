...
public class CyclesBetweenModulesExceptionJPanel extends AbstractDetailsJPanel {
    public static final String ruleTypeKey = "CyclesBetweenModulesException";
    ...
    public CyclesBetweenModulesExceptionJPanel(
