...
public class JTableException extends AbstractJTable implements
	...
	tablemodel.addColumn(ServiceProvider.getInstance().getLocaleService()
		.getTranslatedString("FromModule"));
	tablemodel.addColumn(ServiceProvider.getInstance().getLocaleService()
		.getTranslatedString("ToModule"));
	tablemodel.addColumn(ServiceProvider.getInstance().getLocaleService()
		.getTranslatedString("Description"));
	tablemodel.addColumn(ServiceProvider.getInstance().getLocaleService()
    ...
    // // old
    // // String[] values = new String[] { SoftwareUnitDefinition.PACKAGE,
    // SoftwareUnitDefinition.CLASS, SoftwareUnitDefinition.METHOD };
